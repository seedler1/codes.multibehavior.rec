...
parser.add_argument('--dataset', default='sample', help='dataset name: Rrocket/Kkbox/yoochoose/sample/Rrocket_subset_start/Rrocket_subset_end/Rrocket_subset_random/Rrocket_subset_random_25_percent/Rrocket_subset_random_10_percent')
parser.add_argument('--batch_size', type=int, default=64, help='input batch size')
parser.add_argument('--hidden_size', type=int, default=50, help='hidden state size') # default originally 100
...
def main():
    ...
    lamda = {'Kkbox': 10, 'Rrocket': 1, 'yoochoose': 1, 'sample': 1, 'Rrocket_subset_start': 1, 'Rrocket_subset_end': 1, 'Rrocket_subset_random': 1, 'Rrocket_subset_random_25_percent': 1, 'Rrocket_subset_random_10_percent': 1}
    if opt.l == -1:

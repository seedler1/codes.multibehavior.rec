...
def load_df(dataset):
    ...
    if dataset == 'Rrocket' or dataset == 'sample' or dataset == 'Rrocket_subset_start' or dataset == 'Rrocket_subset_end': # modified bc Rrocket dataset is too huge for me to process on my machine
